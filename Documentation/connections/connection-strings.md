...
| `disableTls` | Set to `true` to connect over plain HTTP/2. Use for local development against a kernel without TLS. |
...
```elixir
{Chronicle.Client, connection_string: "chronicle://localhost:35000?disableTls=true"}
```
